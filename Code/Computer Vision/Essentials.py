...
print(img_color.shape)  # Τυπώνει τις διαστάσεις της εικόνας

cv2.namedWindow('original_color')  # Δημιουργία παραθύρου με όνομα "main"
cv2.imshow('original_color', img_color)  # Προβολή εικόνας στο παράθυρο main
...
cv2.namedWindow('originalt')  # Δημιουργία παραθύρου με όνομα "main"
cv2.imshow('originalt', img)  # Προβολή εικόνας στο παράθυρο main
cv2.waitKey(0)           # Διατηρεί ανοιχτό το πρόγραμμα μέχρι να πατηθεί κάτι
...
cv2.namedWindow('originals')  # Δημιουργία παραθύρου με όνομα "main"
cv2.imshow('originals', img)  # Προβολή εικόνας στο παράθυρο main
cv2.waitKey(0)           # Διατηρεί ανοιχτό το πρόγραμμα μέχρι να πατηθεί κάτι

cv2.namedWindow('Sobel1s')
img2 = cv2.Sobel(img, cv2.CV_8UC1, 0, 1)
cv2.imshow('Sobel1s', img2)
cv2.waitKey(0)

cv2.namedWindow('Sobel2s')
img2 = cv2.Sobel(img, cv2.CV_8UC1, 1, 0)
cv2.imshow('Sobel2s', img2)
cv2.waitKey(0)

cv2.namedWindow('Sobels')
img2 = cv2.Sobel(img, cv2.CV_8UC1, 1, 1)
cv2.imshow('Sobels', img2)
cv2.waitKey(0)
